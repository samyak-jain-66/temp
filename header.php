...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" id="expand" href="expand.php" style="display:none;">ExpandHostel</a>
        </li>
        ...
        <li id="drop" class="nav-item dropdown">
          ...
          Employee Manage</a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              ...
              <a class="dropdown-item" href="employee_list.php">List View</a>
              <a class="dropdown-item" href="update_employee.php">Update Employee</a>
            </div>
        </li>
        <li id="drop" class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Attendance</a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item" href="attendance.php">Add Attendance</a>
